...
<nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark" id="mainNav">
  ...
  <!-- Main section -->
  <div class="artist-banner__container" style="background: url('../images/asim_azhar crop.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat; margin-top:53px;">
    <div></div>
    <div class="artist-banner__overlay">
      <p class="artist-banner__verified">✔ Verified Artist</p>
      <h1 class="artist-banner__name">Asim Azhar</h1>
      <p class="artist-banner__listeners">320,890 monthly listeners</p>
  ...
  <li class="artist-songs__item">
    <img src="../images/dard.jfif" alt="Kesariya" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Dard</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Dard - Asim Azhar 128 Kbps.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio1" src="../AUDIO/Dard - Asim Azhar 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 2 -->
  <li class="artist-songs__item">
    <img src="../images/sajana.jfif" alt="Tum Se Hi" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Sajna</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Sajnaa_1.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio2" src="../AUDIO/Sajnaa_1.mp3"></audio>
  </li>

  <!-- Song 3 -->
  <li class="artist-songs__item">
    <img src="../images/humraah.jfif" alt="Tum Se Hi" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Humraah</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Humraah - Asim Azhar(MyMp3Song).mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio3" src="../AUDIO/Humraah - Asim Azhar(MyMp3Song).mp3"></audio>
  </li>

  <!-- Song 4 -->
  <li class="artist-songs__item">
    <img src="../images/ishqiya.jfif" alt="Tum Se Hi" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Ishqiya</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Ishqiya Ost.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio4" src="../AUDIO/Ishqiya Ost.mp3"></audio>
  </li>

  <!-- Song 5 -->
  <li class="artist-songs__item">
    <img src="../images/habibi.jpeg" alt="habibi" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Habibi</p>
      <p class="artist-songs__plays">2,898,90 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Asim Azhar - Habibi (Official Video)  New Song 2022.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio7" src="../AUDIO/Asim Azhar - Habibi (Official Video)  New Song 2022.mp3"></audio>
  </li>

  <!-- Song 6 -->
  <li class="artist-songs__item">
    <img src="../images/baat.jfif" alt="Tum Se Hi" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Baat</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Baat - (Raag.Fm).mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio5" src="../AUDIO/Baat - (Raag.Fm).mp3"></audio>
  </li>
