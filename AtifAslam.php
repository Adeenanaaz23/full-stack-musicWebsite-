...
<nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark" id="mainNav">
  ...
  <!-- Main section -->
  <div class="artist-banner__container" style="background: url('../images/atif_aslam.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat; margin-top:53px;">
    <div></div>
    <div class="artist-banner__overlay">
      <p class="artist-banner__verified">✔ Verified Artist</p>
      <h1 class="artist-banner__name">Atif Aslam</h1>
...
<ol class="artist-songs__list">
  ...
  <li class="artist-songs__item">
    <img src="../images/aadat.jpg" alt="Aadat" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Aadat</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Aadat Kalyug 128 Kbps.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio1" src="../AUDIO/Aadat Kalyug 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 2 -->
  <li class="artist-songs__item">
    <img src="../images/Bairiyaa-Ramaiya-Vastavaiya-500-500.jpg" alt="Bairiyaa" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Bairiyaa</p>
      <p class="artist-songs__plays">3,702,00 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio2', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Bairiyaa Ramaiya Vastavaiya 128 Kbps.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio2" src="../AUDIO/Bairiyaa Ramaiya Vastavaiya 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 3 -->
  <li class="artist-songs__item">
    <img src="../images/A JAO MERI TAMANAH.jfif" alt="Bakhuda" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Bakhuda</p>
      <p class="artist-songs__plays">430,940 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio3', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Bakhuda Tumhi Ho Remix Kismat Konnection 128 Kbps.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio3" src="../AUDIO/Bakhuda Tumhi Ho Remix Kismat Konnection 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 4 -->
  <li class="artist-songs__item">
    <img src="../images/Woh-Mere-Bin-Atif-Aslam-500-500.jpg" alt="Woh Mere Bin" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Woh Mere Bin</p>
      <p class="artist-songs__plays">1,812,32 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio4', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Woh Mere Bin Atif Aslam 128 Kbps.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio4" src="../AUDIO/Woh Mere Bin Atif Aslam 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 5 -->
  <li class="artist-songs__item">
    <img src="../images/ae dil ha mushkil album.jpg" alt="Raabta" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Raabta</p>
      <p class="artist-songs__plays">812,111,940 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio5', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Darasal Raabta 128 Kbps.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio5" src="../AUDIO/Darasal Raabta 128 Kbps.mp3"></audio>
  </li>
