...
<nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark" id="mainNav">
  ...
  <!-- Main section -->
  <div class="artist-banner__container" style="background: url('../images/pritam_artist crop.jpeg'); background-size: cover; background-position: center center; background-repeat: no-repeat; margin-top:53px;">
    <div></div>
    <div class="artist-banner__overlay">
      <p class="artist-banner__verified">✔ Verified Artist</p>
      <h1 class="artist-banner__name">Pritam</h1>
      <p class="artist-banner__listeners">10,432,123 monthly listeners</p>
...
<ol class="artist-songs__list">
  ...
  <li class="artist-songs__item">
    <img src="../images/CHANNA MERIYA.jfif" alt="Channa Mereya" class="artist-songs__cover">
    
    <div class="artist-songs__info">
      <p class="artist-songs__title">Channa Mereya</p>
      <p class="artist-songs__plays">5,221,034 plays</p>
    </div>
    ...
    <div class="song-actions">
      ...
      <a class="custom-download-button" href="../AUDIO/Channa Mereya Ae Dil Hai Mushkil 128 Kbps copy.mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio1" src="../AUDIO/Channa Mereya Ae Dil Hai Mushkil 128 Kbps copy.mp3"></audio>
  </li>

  <!-- Song 2 -->
  <li class="artist-songs__item">
    <img src="../images/tum se hi.jfif" alt="Tum Se Hi" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Tum Se Hi</p>
      <p class="artist-songs__plays">3,702,000 plays</p>
    </div>
    <div class="song-actions">
      <div class="custom-play-button" onclick="playSong('audio2', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a class="custom-download-button" href="../AUDIO/Tum Se Hi - (Raag.Fm).mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio2" src="../AUDIO/Tum Se Hi - (Raag.Fm).mp3"></audio>
  </li>

  <!-- Song 3 -->
  <li class="artist-songs__item">
    <img src="../images/A JAO MERI TAMANAH.jfif" alt="Aa Jao Meri Tamanna" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Aa Jao Meri Tamanna</p>
      <p class="artist-songs__plays">6,650,940 plays</p>
    </div>
    <div class="song-actions">
      <div class="custom-play-button" onclick="playSong('audio3', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a class="custom-download-button" href="../AUDIO/Aa Jao Meri Tamanna Ajab Prem Ki Ghazab Kahani 128 Kbps.mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio3" src="../AUDIO/Aa Jao Meri Tamanna Ajab Prem Ki Ghazab Kahani 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 4 -->
  <li class="artist-songs__item">
    <img src="../images/download (9).jfif" alt="Badtameez Dil" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Badtameez Dil</p>
      <p class="artist-songs__plays">1,812,320 plays</p>
    </div>
    <div class="song-actions">
      <div class="custom-play-button" onclick="playSong('audio4', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a class="custom-download-button" href="../AUDIO/Badtameez Dil Yeh Jawaani Hai Deewani 128 Kbps.mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio4" src="../AUDIO/Badtameez Dil Yeh Jawaani Hai Deewani 128 Kbps.mp3"></audio>
  </li>

  <!-- Song 5 -->
  <li class="artist-songs__item">
    <img src="../images/ae dil ha mushkil album.jpg" alt="Ae Dil Hai Mushkil" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Ae Dil Hai Mushkil</p>
      <p class="artist-songs__plays">812,940 plays</p>
    </div>
    <div class="song-actions">
      <div class="custom-play-button" onclick="playSong('audio5', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a class="custom-download-button" href="../AUDIO/Ae Dil Hai Mushkil Title Track Pritam 128 Kbps.mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio5" src="../AUDIO/Ae Dil Hai Mushkil Title Track Pritam 128 Kbps.mp3"></audio>
  </li>
</ol>
