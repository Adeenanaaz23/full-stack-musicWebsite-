...
<nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark" id="mainNav">
  ...
  <!-- Main section -->
<div class="artist-banner__container" style="background: url('../images/Adobe Express - file.jpg'); background-size: cover; background-position: top center; background-repeat: no-repeat; margin-top:53px;">
    <div></div>
    <div class="artist-banner__overlay" >
      <p class="artist-banner__verified">✔ Verified Artist</p>
      <h1 class="artist-banner__name">Bayaan</h1>
...
<ol class="artist-songs__list">
  ...
  <li class="artist-songs__item">
    <img src="../images/maand....jpg" alt="Maand" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Maand</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Bayaan  Hasan Raheem  Rovalio - Maand (Lyric Video).mp3" download style="margin-left: 8px; color: #000;">
        <i class="fas fa-download custom-download-button"></i>
      </a>
    </div>
    <audio id="audio1" src="../AUDIO/Bayaan  Hasan Raheem  Rovalio - Maand (Lyric Video).mp3"></audio>
  </li>

  <!-- Song 2 -->
  <li class="artist-songs__item">
    <img src="../images/tere naal.jpg" alt="tere naal" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Tere naal</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Bayaan  Sanah Moidutty  Vaibhav Pani  - Tere Naal (Lyric Video).mp3" download style="margin-left: 8px; color: #000;">
        <i class="fas fa-download custom-download-button"></i>
      </a>
    </div>
    <audio id="audio2" src="../AUDIO/Bayaan  Sanah Moidutty  Vaibhav Pani  - Tere Naal (Lyric Video).mp3"></audio>
  </li>

  <!-- Song 3 -->
  <li class="artist-songs__item">
    <img src="../images/teri tasveer.jpg" alt="teri tasveer" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Teri tasveer</p>
      <p class="artist-songs__plays">370,950 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio3', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Bayaan feat. Rufus Shahzad - Teri Tasveer.mp3" download style="margin-left: 8px; color: #000;">
        <i class="fas fa-download custom-download-button"></i>
      </a>
    </div>
    <audio id="audio3" src="../AUDIO/Bayaan feat. Rufus Shahzad - Teri Tasveer.mp3"></audio>
  </li>

  <!-- Song 4 -->
  <li class="artist-songs__item">
    <img src="../images/safar.jpg" alt="Safar" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Safar</p>
    ...
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/Bayaan  Sherazam - Safar.mp3" download style="margin-left: 8px; color: #000;">
        <i class="fas fa-download custom-download-button"></i>
      </a>
    </div>
    <audio id="audio4" src="../AUDIO/Bayaan  Sherazam - Safar.mp3"></audio>
  </li>

  <!-- Song 5 -->
  <li class="artist-songs__item">
    <img src="../images/nahin milta.jpg" alt="nahin milta" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Nahin milta</p>
      <p class="artist-songs__plays">912,133,940 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio5', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Bayaan - Nahin Milta (Official Video).mp3" download style="margin-left: 8px; color: #000;">
        <i class="fas fa-download custom-download-button"></i>
      </a>
    </div>
    <audio id="audio5" src="../AUDIO/Bayaan - Nahin Milta (Official Video).mp3"></audio>
  </li>
