...
<nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark" id="mainNav">
  ...
  <!-- Main section -->
  <div class="artist-banner__container" style="background: url('../images/abdul_hannan.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat; margin-top:44px;">
    <div></div>
...
<ol class="artist-songs__list">
  ...
  <li class="artist-songs__item">
    <img src="../images/kinaray.jpeg" alt="kinaray" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Kinaray</p>
    ...
    <div class="song-actions">
      ...
      <a class="custom-download-button" href="../AUDIO/Abdul Hannan - Kinaaray (Official Video).mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio1" src="../AUDIO/Abdul Hannan - Kinaaray (Official Video).mp3"></audio>
  </li>

  <!-- Song 2 -->
  <li class="artist-songs__item">
    <img src="../images/jaaye.jpg" alt="jaaye" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Jaaye</p>
      <p class="artist-songs__plays">645,000 plays</p>
    </div>
    <div class="song-actions">
      <div class="custom-play-button" onclick="playSong('audio2', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a class="custom-download-button" href="../AUDIO/Abdul Hannan - Jaaye (Official Lyrics Video).mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio2" src="../AUDIO/Abdul Hannan - Jaaye (Official Lyrics Video).mp3"></audio>
  </li>

  <!-- Song 3 -->
  <li class="artist-songs__item">
    <img src="../images/bikhra.jpeg" alt="bikhra" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Bikhra</p>
    ...
    <div class="song-actions">
      ...
      <a class="custom-download-button" href="../AUDIO/Rovalio & Abdul Hannan - Bikhra (Official Music Video).mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio3" src="../AUDIO/Rovalio & Abdul Hannan - Bikhra (Official Music Video).mp3"></audio>
  </li>

  <!-- Song 4 -->
  <li class="artist-songs__item">
    <img src="../images/iraday.jpg" alt="iraday" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Iraday</p>
      <p class="artist-songs__plays">1,000,043 plays</p>
    </div>
    <div class="song-actions">
      <div class="custom-play-button" onclick="playSong('audio4', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a class="custom-download-button" href="../AUDIO/Abdul Hannan & Rovalio - Iraaday (Official Music Video).mp3" download>
        <i class="fas fa-download"></i>
      </a>
    </div>
    <audio id="audio4" src="../AUDIO/Abdul Hannan & Rovalio - Iraaday (Official Music Video).mp3"></audio>
  </li>
</ol>
