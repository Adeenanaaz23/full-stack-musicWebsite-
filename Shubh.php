...
<nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark" id="mainNav">
  ...
  <!-- Main section -->
  <div class="artist-banner__container" style="background: url('../images/anuv_jain crop.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat; margin-top:53px;">
    <div></div>
    <div class="artist-banner__overlay">
      <p class="artist-banner__verified">✔ Verified Artist</p>
      <h1 class="artist-banner__name">Anuv Jain</h1>
...
<ol class="artist-songs__list">
  ...
  <li class="artist-songs__item">
    <img src="../images/afsos.jpg" alt="Afsos" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Afsos</p>
      <p class="artist-songs__plays">786,111 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio1', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Anuv Jain - AFSOS ft. AP Dhillon (Official Visualizer) (1).mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio1" src="../AUDIO/Anuv Jain - AFSOS ft. AP Dhillon (Official Visualizer) (1).mp3"></audio>
  </li>

  <!-- Song 2 -->
  <li class="artist-songs__item">
    <img src="../images/jo tum meray ho.jpg" alt="Jo Tum Meray Ho" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Jo Tum Meray Ho</p>
      <p class="artist-songs__plays">645,00 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio2', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Anuv Jain - JO TUM MERE HO (Official Video).mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio2" src="../AUDIO/Anuv Jain - JO TUM MERE HO (Official Video).mp3"></audio>
  </li>

  <!-- Song 3 -->
  <li class="artist-songs__item">
    <img src="../images/husn.jpg" alt="Husn" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Husn</p>
      <p class="artist-songs__plays">930,734 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio3', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Anuv Jain - HUSN (Official Video).mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio3" src="../AUDIO/Anuv Jain - HUSN (Official Video).mp3"></audio>
  </li>

  <!-- Song 4 -->
  <li class="artist-songs__item">
    <img src="../images/alag aasman.jpg" alt="Alag Aasman" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Alag Aasman</p>
      <p class="artist-songs__plays">1,000,43 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      <div class="custom-play-button" onclick="playSong('audio4', this)">
        <i class="fas fa-play-circle"></i>
      </div>
      <a href="../AUDIO/Anuv Jain - ALAG AASMAAN (a song on the ukulele).mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio4" src="../AUDIO/Anuv Jain - ALAG AASMAAN (a song on the ukulele).mp3"></audio>
  </li>

  <!-- Song 5 -->
  <li class="artist-songs__item">
    <img src="../images/baarishein.jpg" alt="Baarishein" class="artist-songs__cover">
    <div class="artist-songs__info">
      <p class="artist-songs__title">Baarishein</p>
      <p class="artist-songs__plays">1,000,43 plays</p>
    </div>
    <div style="display: flex; align-items: center;">
      ...
      <a href="../AUDIO/BAARISHEIN (Studio) Anuv Jain.mp3" download style="margin-left: 8px; color: #000; display: flex; align-items: center;">
        <i class="fas fa-download custom-download-button" style="margin-right: 4px;"></i>
      </a>
    </div>
    <audio id="audio5" src="../AUDIO/BAARISHEIN (Studio) Anuv Jain.mp3"></audio>
  </li>
